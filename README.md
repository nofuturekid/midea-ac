...
**Note: Only air conditioner devices (type 0xAC and 0xCC) are supported.**

See [Getting Device Info](#getting-device-info) to determine if a device is supported.

## About This Distribution

This is a merged build maintained under `nofuturekid`, combining three sources on top of the current [mill1000](https://github.com/mill1000/midea-ac-py) upstream. It depends on the companion library [nofuturekid/midea-msmart](https://github.com/nofuturekid/midea-msmart), which is installed automatically.

| Source                                                                | Features merged in                                                                                                                                                         |
| --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [mill1000/midea-ac-py](https://github.com/mill1000/midea-ac-py)       | Upstream base — discovery, climate control and all core entities.                                                                                                          |
| [gilbertorconde/midea-ac](https://github.com/gilbertorconde/midea-ac) | Power-on/off timer number entities (1-minute step), filter reset buttons, `filter_alert` binary sensor, extended AC feature switches/entities, extra translations & icons. |
| [TurboLed/midea-ac-py](https://github.com/TurboLed/midea-ac-py)       | Diagnostic sensors: outdoor unit power, louver angle, compressor frequency, coil temperatures (T2/T3), discharge temperature (TP), indoor fan speed and defrost.           |
...
[![Install via HACs on your Home Assistant instance.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=nofuturekid&repository=midea-ac&category=integrations)
...
**Note: Depending on your location, a different cloud region may be necessary to authenticate V3 devices. If you are unable to add a device with your region, please try again with the other region options.**
...
- [AC Device](https://github.com/nofuturekid/midea-msmart/blob/main/msmart/device/AC/device.py)
- [CC Device](https://github.com/nofuturekid/midea-msmart/blob/main/msmart/device/CC/device.py)
...
Use [msmart-ng](https://github.com/nofuturekid/midea-msmart) to obtain device information.
